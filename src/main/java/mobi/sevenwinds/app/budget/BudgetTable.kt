...
class BudgetEntity(id: EntityID<Int>) : IntEntity(id) {
    ...
    var authorEntity by AuthorEntity referencedOn BudgetTable.author

    fun toResponseFio(): BudgetRecordFio {
        return BudgetRecordFio(
            year, month, amount, type, authorEntity.fio, authorEntity.date)
    }
